...
QT_MOC_LITERAL(4, 43, 17) // "animationFinished"
    ...
    "AnimationStackedWidget\0valueChanged\0"
...
void AnimationStackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AnimationStackedWidget *_t = static_cast<AnimationStackedWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AnimationStackedWidget::staticMetaObject = {
    { &QStackedWidget::staticMetaObject, qt_meta_stringdata_AnimationStackedWidget.data,
      qt_meta_data_AnimationStackedWidget,  qt_static_metacall, nullptr, nullptr}
};
