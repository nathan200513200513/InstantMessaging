...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TcpMsgServer *_t = static_cast<TcpMsgServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (TcpMsgServer::*_t)(const QJsonValue & );
...
QT_INIT_METAOBJECT const QMetaObject TcpMsgServer::staticMetaObject = {
    { &TcpServer::staticMetaObject, qt_meta_stringdata_TcpMsgServer.data,
      qt_meta_data_TcpMsgServer,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TcpFileServer *_t = static_cast<TcpFileServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (TcpFileServer::*_t)(int , const QJsonValue & );
...
QT_INIT_METAOBJECT const QMetaObject TcpFileServer::staticMetaObject = {
    { &TcpServer::staticMetaObject, qt_meta_stringdata_TcpFileServer.data,
      qt_meta_data_TcpFileServer,  qt_static_metacall, nullptr, nullptr}
};
