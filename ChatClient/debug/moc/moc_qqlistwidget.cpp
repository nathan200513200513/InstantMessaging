...
void QQListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QQListWidget *_t = static_cast<QQListWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QQListWidget::*_t)(QQListWidget * , QQPopMenuWidget * , QMenu * );
        ...
        {
            typedef void (QQListWidget::*_t)(QQCell * );
...
QT_INIT_METAOBJECT const QMetaObject QQListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_QQListWidget.data,
      qt_meta_data_QQListWidget,  qt_static_metacall, nullptr, nullptr}
};
