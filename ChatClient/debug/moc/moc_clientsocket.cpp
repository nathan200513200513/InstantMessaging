...
void ClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ClientSocket::*_t)(const quint8 & , const QJsonValue & );
        ...
        {
            typedef void (ClientSocket::*_t)(const quint8 & );
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ClientFileSocket *_t = static_cast<ClientFileSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ClientFileSocket::*_t)();
        ...
        {
            typedef void (ClientFileSocket::*_t)(const quint8 & , const QString & );
        ...
        {
            typedef void (ClientFileSocket::*_t)(quint64 , quint64 );
...
QT_INIT_METAOBJECT const QMetaObject ClientFileSocket::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ClientFileSocket.data,
      qt_meta_data_ClientFileSocket,  qt_static_metacall, nullptr, nullptr}
};
