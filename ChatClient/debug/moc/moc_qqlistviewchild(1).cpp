...
void QQListViewChild::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QQListViewChild *_t = static_cast<QQListViewChild *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QQListViewChild::*_t)(QQListViewChild * );
        ...
        {
            typedef void (QQListViewChild::*_t)(QQCell * );
...
QT_INIT_METAOBJECT const QMetaObject QQListViewChild::staticMetaObject = {
    { &QQPopMenuWidget::staticMetaObject, qt_meta_stringdata_QQListViewChild.data,
      qt_meta_data_QQListViewChild,  qt_static_metacall, nullptr, nullptr}
};
