...
void QQListViewGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QQListViewGroup *_t = static_cast<QQListViewGroup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QQListViewGroup::*_t)(QQListViewGroup * );
...
QT_INIT_METAOBJECT const QMetaObject QQListViewGroup::staticMetaObject = {
    { &QQPopMenuWidget::staticMetaObject, qt_meta_stringdata_QQListViewGroup.data,
      qt_meta_data_QQListViewGroup,  qt_static_metacall, nullptr, nullptr}
};
